            ...
            <div class="row align-self-center mb-2">
                <div class="col-6">
                    <%--지도위치--%>
                        ...
                        <button id="btn-reload" class="mt-3 btn btn-outline-success shadow" type="button">
                            Reload
                        </button>
                </div>
                <div class="col-5 ms-1">
                    ...
                    <div class="row d-flex justify-content-end mb-2">
                        작성자:
                        ${loginMember.loginId}
                        <div id="memberId" style="display: none">${loginMember.id}</div>
                    </div>
                    <div class="h5 row d-flex justify-content-start">
                        Title
                    </div>
                    <div class="row d-flex justify-content-around mb-2">
                        <input type="text" class="form-control shadow-sm" placeholder="제목" id="title">
                    </div>
                    <div class="h5 row d-flex justify-content-start">
                        Content
                    </div>
                    <div class="row d-flex justify-content-around mb-2">
                        <textarea class="form-control shadow-sm" placeholder="내용" rows="10" id="content"></textarea>
                    </div>
                    <div class="ros d-flex justify-content-center">
                        <button id="btn-write" class="btn btn-outline-success shadow" type="button">
                            Write
                        </button>
                    </div>
                </div>
...
<script src="resources/static/assets/js/plan/write.js"></script>
